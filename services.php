    ...
    <div class="services-container">
        <div class="services-top">
            <div class="services-header">
                <p class="services-desc">Our Services</p>
                <h2 class="services-desc-title">Look Our Best Services</h2>
            ...
            <div class="services-content">
                <div class="services-inner">
                    <p class="services-paragraph">
                        Discover how OCTO Digital Solutions can transform your organization with our comprehensive suite of services.
                    </p>
                </div>
            </div>
        </div>
            ...
            <ul class="services-points">
                <li>
                    ...
                    <div class="service-text">
                        ...
                        <p>Tailored software to meet your unique business needs</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="service-text">
                        ...
                        <p>Protecting your digital assets with robust security measures</p>
                    </div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="service-text">
                        ...
                        <p>Seamless cloud migration and management for enhanced scalability</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="service-text">
                        ...
                        <p>Optimizing your IT infrastructure for peak performance and reliability</p>
                    </div>
                </li>
                <li>
                    ...
                    <div class="service-text">
                        ...
                        <p>Enhancing organizational effectiveness through tailored development programs</p>
                    </div>
                </li>
            </ul>
        </div>
...
<article class="black-box services-industries">
    <div class="black-box-container">
        ...
        <section class="black-master-columns">
            <div class="black-box-columns">
                <h3>API Development</h3>
                <h3>Application Development</h3>
                <h3>Backup & Disaster Recovery</h3>
            </div>

            <div class="black-box-columns active-column">
                <h3>Business Process Outsourcing</h3>
                <h3>Digital Transformation</h3>
                <h3>Partner Product Support</h3>
                <h3>SLA Support</h3>
            </div>

            <div class="black-box-columns">
                <h3>Startup & MVP Services</h3>
                <h3>Systems Integration</h3>
                <h3>Payment Services</h3>
                <h3>Sustainability Statement (ESG)</h3>
            </div>
        </section>
</article>
...
<article class="industries-section">
    <div class="industries-container">
        ...
        <div class="industries-content">
            <section class="industry-wrapper collapsed">
            <div class="industry-grid">
                <div class="industry-item">
                    <div class="icon-circle"><i class="fas fa-tractor"></i></div>
                    <h3>Agriculture</h3>
                </div>
                <div class="industry-item">
                ...
                <div class="industry-item">
                    ...
                    <h3>Human Capital Management (HCM/HR)</h3>
                </div>
                <div class="industry-item">
                ...
                <div class="industry-item">
                    <div class="icon-circle"><i class="fas fa-photo-video"></i></div>
                ...
                <div class="industry-item">
                    <div class="icon-circle"><i class="fas fa-oil-can"></i></div>
                ...
                <div class="industry-item">
                    <div class="icon-circle"><i class="fas fa-football-ball"></i></div>
                    <h3>Sports</h3>
                </div>
                <div class="industry-item">
...
<?php
    ...
    showCarousel('partners', 'Our Partners');
    showCarousel('clients', 'Our Clients');
?>
...
<article class="portfolio-section">
    <div class="portfolio-container">
        ...
        <div class="portfolio-content">
            <div class="portfolioto-inner">
                <p>
                    As a mobile and web-based application development company with skilled consultants, and  software developers, OctoDigital combines technological expertise, specific domain experience, and a passion for excellence to deliver enterprise-grade solutions.
                </p>
            </div>
        </div>
    </div>
